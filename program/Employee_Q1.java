...
public class Employee_Q1 extends PersonQ1 {
	@Override
	public String toString() {
		return "Employee_Q1 [salary=" + salary + ", date_of_joining=" + date_of_joining + ", base_location="
	...
	public Employee_Q1(int Pid, String pname ,String paddress,String dob ) {
