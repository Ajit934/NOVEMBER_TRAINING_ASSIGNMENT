...
public class Test_Q_12 {
	public static void main(String[] args) {

		List<Item_Q_12> itemList = new ArrayList<>();
		itemList.add(new Item_Q_12(1, "Mobile", LocalDateTime.of(2022, 12, 01, 01, 10),LocalDateTime.of(2023, 12, 01, 01, 10), 10000f));
		itemList.add(new Item_Q_12(2, "TV", LocalDateTime.of(2022, 11, 01, 01, 10), LocalDateTime.of(2024, 11, 01, 01, 20),20000f));
		itemList.add(new Item_Q_12(3, "Watch", LocalDateTime.of(2022, 12, 01, 01, 10), null, 100f));
		itemList.add(new Item_Q_12(4, "Dresses", LocalDateTime.of(2022, 12, 01, 01, 10), null, 2000f));
		itemList.add(new Item_Q_12(5, "Jwellary", LocalDateTime.of(2022, 10, 01, 01, 10), null, 2000f));
		...
		Set<Item_Q_12>list=itemList.stream().map(i->new Item_Q_12(i.getIname(),i.getPrice() ) ).collect(Collectors.toSet());
		System.out.println("Set of item name and price :");
		for (Item_Q_12 item1 : list) {
