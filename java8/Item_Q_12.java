...
public class Item_Q_12{
	private int itemid;
	private String iname;
	private LocalDateTime date_of_manufacturing, date_of_expiry;
	private float price;

	public Item_Q_12(int itemid, String iname, LocalDateTime date_of_manufacturing, LocalDateTime date_of_expiry,
			float price) {
		super();
		this.itemid = itemid;
		this.iname = iname;
	...
	public Item_Q_12(String iname, float price) {
		super();
		this.iname = iname;
		this.price = price;
	}
